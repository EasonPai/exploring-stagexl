...
["", "TestingDrawing.dart", , X, {
  ...
  main: [function() {
    ...
    t3 = J.get$onClick$x(document.querySelector("#mode1"));
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t3._target, t3._eventType, W._wrapZone(new X.main_closure()), t3._useCapture), [H.getTypeArgumentByIndex(t3, 0)])._tryResume$0();
    t3 = J.get$onClick$x(document.querySelector("#mode2"));
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t3._target, t3._eventType, W._wrapZone(new X.main_closure0()), t3._useCapture), [H.getTypeArgumentByIndex(t3, 0)])._tryResume$0();
    t3 = J.get$onClick$x(document.querySelector("#clean"));
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t3._target, t3._eventType, W._wrapZone(new X.main_closure1()), t3._useCapture), [H.getTypeArgumentByIndex(t3, 0)])._tryResume$0();
    ...
    $.stage.on$1(0, C.EventStreamProvider_enterFrame.eventType).listen$1(new X.main_closure2(stats));
    J.click$0$x(document.querySelector("#mode1"));
  }, "call$0", "main$closure", 0, 0, 0],
  startStatic: function(startx, starty) {
    var t1, t2;
    ...
    $.drawBody.applyCache$5$debugBorder(0, 0, 900, 500, true);
    $.touchListener = $.background.on$1(0, C.EventStreamProvider_mouseMove.eventType).listen$1(new X.startStatic_closure(startx, starty));
    $.background.on$1(0, C.EventStreamProvider_mouseUp.eventType).listen$1(new X.startStatic_closure0());
  },
  startDynamic: function(startx, starty) {
    var t1, t2;
    t1 = H.setRuntimeTypeInfo([], [Z._GraphicsCommand]);
    t2 = $.DisplayObject__nextID;
    $.DisplayObject__nextID = t2 + 1;
    ...
    t1 = $.stage;
    t1.addChildAt$2(t2, t1._children.length);
    $.touchListener = $.background.on$1(0, C.EventStreamProvider_mouseMove.eventType).listen$1(new X.startDynamic_closure(startx, starty));
    $.background.on$1(0, C.EventStreamProvider_mouseUp.eventType).listen$1(new X.startDynamic_closure0());
    $.minx = startx;
    $.miny = starty;
    $.maxx = startx;
    $.maxy = starty;
  },
  updateButton: function(target) {
    var btns, t1;
  ...
  main_closure: {
    "^": "Closure:9;",
    call$1: function(e) {
      var t1 = $.mouseDownListener;
      if (t1 != null)
        t1.cancel$0();
      $.mouseDownListener = $.background.on$1(0, C.EventStreamProvider_mouseDown.eventType).listen$1(new X.main__closure());
      X.updateButton(H.interceptedTypeCast(J.get$target$x(e), "$isElement"));
    }
  },
  main__closure: {
    "^": "Closure:9;",
    call$1: function(e) {
      X.startDynamic(C.JSNumber_methods.toInt$0(e.get$localX()), C.JSNumber_methods.toInt$0(e.get$localY()));
    }
  },
  main_closure0: {
    "^": "Closure:9;",
    call$1: function(e) {
      ...
      if (t1 != null)
        t1.cancel$0();
      $.mouseDownListener = $.background.on$1(0, C.EventStreamProvider_mouseDown.eventType).listen$1(new X.main__closure0());
      X.updateButton(H.interceptedTypeCast(J.get$target$x(e), "$isElement"));
    }
  },
  main__closure0: {
    "^": "Closure:9;",
    call$1: function(e) {
      X.startStatic(C.JSNumber_methods.toInt$0(e.get$localX()), C.JSNumber_methods.toInt$0(e.get$localY()));
    }
  },
  main_closure1: {
    "^": "Closure:9;",
    call$1: function(e) {
      var t1 = $.stage;
      t1.removeChildren$2(1, t1._children.length - 1);
    }
  },
  main_closure2: {
    "^": "Closure:10;stats_0",
  ...
  startStatic_closure: {
    "^": "Closure:9;startx_0,starty_1",
    call$1: function(e) {
      var t1, t2, t3, t4;
      t1 = C.JSNumber_methods.toInt$0(e.get$localX());
      t2 = C.JSNumber_methods.toInt$0(e.get$localY());
      t3 = $.drawBody._graphics;
      ...
      t3._identityRectangleRefresh = true;
      $.drawBody.refreshCache$0();
    }
  },
  startStatic_closure0: {
    "^": "Closure:9;",
    call$1: function(e) {
      $.touchListener.cancel$0();
    }
  },
  startDynamic_closure: {
    "^": "Closure:9;startx_0,starty_1",
    call$1: function(e) {
      var t1, t2, t3, t4;
      t1 = C.JSNumber_methods.toInt$0(e.get$localX());
      ...
      t2 = $.minx;
      t4 = $.miny;
      t3.applyCache$5$debugBorder(t2 - 5, t4 - 5, $.maxx - t2 + 10, $.maxy - t4 + 10, true);
      $.drawBody.refreshCache$0();
    }
  },
  startDynamic_closure0: {
    "^": "Closure:9;",
    call$1: function(e) {
      $.touchListener.cancel$0();
    }
...
["stagexl", "package:stagexl/stagexl.dart", , Z, {
  ...
  BitmapData: {
    ...
    static: {"^": "BitmapData_defaultLoadOptions"}
  },
  DisplayObject: {
    "^": "EventDispatcher;",
    get$root: function() {
    ...
    applyCache$5$debugBorder: function(x, y, width, height, debugBorder) {
      var pixelRatio, t1, renderTexture, t2, t3;
      ...
      if (width !== renderTexture._width || height !== renderTexture._height) {
        renderTexture._width = Z._ensureInt(width);
        renderTexture._height = Z._ensureInt(height);
        renderTexture._storeWidth = C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(renderTexture._width * renderTexture._storePixelRatio));
        renderTexture._storeHeight = C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(renderTexture._height * renderTexture._storePixelRatio));
        t1 = renderTexture._canvas;
        t2 = renderTexture._storeWidth;
        t3 = $.get$_backingStorePixelRatio();
        J.set$width$x(t1, C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t2 / t3)));
        J.set$height$x(renderTexture._canvas, C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(renderTexture._storeHeight / t3)));
        renderTexture._quad = Z.RenderTextureQuad$(renderTexture, 0, 0, 0, 0, 0, renderTexture._width, renderTexture._height);
      }
  ...
  Sprite: {
    ...
    get$graphics: function() {
      ...
      if (t1 != null)
        ...
        t1 = new Z.Graphics(H.setRuntimeTypeInfo([], [Z._GraphicsCommand]), new Z.Rectangle0(0, 0, 0, 0), true);
        this._graphics = t1;
      }
      return t1;
    },
    getBoundsTransformed$2: function(matrix, returnRectangle) {
      ...
      if (t1 != null) {
        ...
        returnRectangle = new Z.Rectangle0(rLeft, rTop, P.max(t1.x + t1.width, returnRectangle.x + returnRectangle.width) - rLeft, P.max(t1.y + t1.height, returnRectangle.y + returnRectangle.height) - rTop);
      }
      return returnRectangle;
    },
    getBoundsTransformed$1: function(matrix) {
...
function dart_precompiled($collectedClasses) {
  ...
  function main_closure2(stats_0) {
  ...
  function startStatic_closure(startx_0, starty_1) {
    this.startx_0 = startx_0;
    this.starty_1 = starty_1;
  }
  startStatic_closure.builtin$cls = "startStatic_closure";
  if (!"name" in startStatic_closure)
    startStatic_closure.name = "startStatic_closure";
  $desc = $collectedClasses.startStatic_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  startStatic_closure.prototype = $desc;
  function startStatic_closure0() {
  }
  startStatic_closure0.builtin$cls = "startStatic_closure0";
  if (!"name" in startStatic_closure0)
    startStatic_closure0.name = "startStatic_closure0";
  $desc = $collectedClasses.startStatic_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  startStatic_closure0.prototype = $desc;
  function startDynamic_closure(startx_0, starty_1) {
    this.startx_0 = startx_0;
    this.starty_1 = starty_1;
  }
  startDynamic_closure.builtin$cls = "startDynamic_closure";
  if (!"name" in startDynamic_closure)
    startDynamic_closure.name = "startDynamic_closure";
  $desc = $collectedClasses.startDynamic_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  startDynamic_closure.prototype = $desc;
  function startDynamic_closure0() {
  }
  startDynamic_closure0.builtin$cls = "startDynamic_closure0";
  if (!"name" in startDynamic_closure0)
    startDynamic_closure0.name = "startDynamic_closure0";
  $desc = $collectedClasses.startDynamic_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  startDynamic_closure0.prototype = $desc;
