...
["", "TestingDrawing_v4.dart", , T, {
  ...
  main: [function() {
    ...
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new T.main_closure()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
    ...
    $.stage.on$1(0, C.EventStreamProvider_enterFrame.eventType).listen$1(new T.main_closure0(stats));
    ...
    $.mouseDownListener = $.background.on$1(0, C.EventStreamProvider_mouseDown.eventType).listen$1(new T.main_closure1());
  }, "call$0", "main$closure", 0, 0, 0],
  startStatic: function(startx, starty) {
    $.get$pixels().push(new Z.Point(startx, starty));
    $.touchListener = $.background.on$1(0, C.EventStreamProvider_mouseMove.eventType).listen$1(new T.startStatic_closure());
    $.background.on$1(0, C.EventStreamProvider_mouseUp.eventType).listen$1(new T.startStatic_closure0());
  },
  drawStatic: function(toX, toY) {
    ...
    if ($.get$pixels().length > $.CACHE_THRESHOLD) {
      T.endDraw();
      T.startStatic(toX, toY);
      return;
    }
    t1 = $.penCanvas._graphics;
    ...
    t1._identityRectangleRefresh = true;
    for (i = 1; t1 = $.get$pixels(), t2 = t1.length, t3 = $.penCanvas, i < t2; ++i) {
      t2 = t3._graphics;
      t1 = t1[i];
      t3 = J.get$x$x(t1);
      t1 = J.get$y$x(t1);
  ...
  endDraw: function() {
    var t1, t2, drawMatrix, renderState;
    $.pixels = [];
    document.querySelector("#points").textContent = "Points: " + C.JSInt_methods.toString$0($.get$pixels().length);
    t1 = $.canvasBitmapData;
    t2 = $.penCanvas;
  ...
  main_closure1: {
    "^": "Closure:9;",
    call$1: function(e) {
      T.startStatic(C.JSNumber_methods.toInt$0(e.get$localX()), C.JSNumber_methods.toInt$0(e.get$localY()));
    }
  },
  startStatic_closure: {
    "^": "Closure:9;",
    call$1: function(e) {
      T.drawStatic(C.JSNumber_methods.toInt$0(e.get$localX()), C.JSNumber_methods.toInt$0(e.get$localY()));
    }
  },
  ...
  EventStream: {
    ...
    _dispatchEventInternal$3: function($event, target, eventPhase) {
      ...
      for (t1 = subscriptions.length, t2 = this._stagexl$_target, t3 = eventPhase === 1, i = 0; i < t1; ++i) {
        subscription = subscriptions[i];
        if (subscription.get$isCanceled() || subscription._stagexl$_pauseCount > 0 || subscription._captures !== t3)
          continue;
...
;(function (callback) {
  ...
  if (typeof dartMainRunner === "function") {
    dartMainRunner((function(a){H.startRootIsolate(T.main$closure(),a)}), []);
  } else {
    (function(a){H.startRootIsolate(T.main$closure(),a)})([]);
  }
});
// END invoke [main].
function init() {
...
function dart_precompiled($collectedClasses) {
  ...
  function main_closure0(stats_0) {
  ...
  function DisplayObject(_parent) {
    this._parent = _parent;
  }
