...
["", "TestingDrawing_v2.dart", , E, {
  ...
  main: [function() {
    ...
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t3._target, t3._eventType, W._wrapZone(new E.main_closure()), t3._useCapture), [H.getTypeArgumentByIndex(t3, 0)])._tryResume$0();
    ...
    $.stage.on$1(0, C.EventStreamProvider_enterFrame.eventType).listen$1(new E.main_closure0(stats));
    $.mouseDownListener = $.background.on$1(0, C.EventStreamProvider_mouseDown.eventType).listen$1(new E.main_closure1());
  ...
  startStatic: function(startx, starty) {
    ...
    $.touchListener = $.background.on$1(0, C.EventStreamProvider_mouseMove.eventType).listen$1(new E.startStatic_closure());
    $.background.on$1(0, C.EventStreamProvider_mouseUp.eventType).listen$1(new E.startStatic_closure0());
  },
  drawStatic: function(toX, toY) {
    var t1, i, t2, t3, t4, t5;
    $.get$pixels().push(new Z.Point(toX, toY));
    P.print("pixel length > " + $.get$pixels().length);
    if ($.get$pixels().length > 1000)
      ;
    t1 = $.drawBody._graphics;
    C.JSArray_methods.set$length(t1._commands, 0);
    t1._identityRectangleRefresh = true;
    for (i = 0; t1 = $.get$pixels(), i < t1.length; ++i) {
      if (i > 1) {
        t2 = $.drawBody._graphics;
        t3 = i - 1;
        t4 = J.get$x$x(t1[t3]);
        t3 = J.get$y$x(t1[t3]);
  ...
  main_closure1: {
    "^": "Closure:9;",
    call$1: function(e) {
      E.startStatic(C.JSNumber_methods.toInt$0(e.get$localX()), C.JSNumber_methods.toInt$0(e.get$localY()));
    }
  },
  startStatic_closure: {
    "^": "Closure:9;",
    call$1: function(e) {
      E.drawStatic(C.JSNumber_methods.toInt$0(e.get$localX()), C.JSNumber_methods.toInt$0(e.get$localY()));
    }
  },
