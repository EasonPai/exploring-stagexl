...
["", "TestingDrawing_v3.dart", , A, {
  ...
  main: [function() {
    ...
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t3._target, t3._eventType, W._wrapZone(new A.main_closure()), t3._useCapture), [H.getTypeArgumentByIndex(t3, 0)])._tryResume$0();
    ...
    $.stage.on$1(0, C.EventStreamProvider_enterFrame.eventType).listen$1(new A.main_closure0(stats));
    ...
    t3 = $.stage;
    t3.addChildAt$2(t2, t3._children.length);
    $.penCanvas.applyCache$5$debugBorder(0, 0, 900, 500, true);
    ...
    $.mouseDownListener = $.background.on$1(0, C.EventStreamProvider_mouseDown.eventType).listen$1(new A.main_closure1());
  }, "call$0", "main$closure", 0, 0, 0],
  startStatic: function(startx, starty) {
    $.get$pixels().push(new Z.Point(startx, starty));
    $.touchListener = $.background.on$1(0, C.EventStreamProvider_mouseMove.eventType).listen$1(new A.startStatic_closure());
    $.background.on$1(0, C.EventStreamProvider_mouseUp.eventType).listen$1(new A.startStatic_closure0());
  },
  drawStatic: function(toX, toY) {
    ...
    if ($.get$pixels().length > 1000) {
      A.endDraw();
      A.startStatic(toX, toY);
      return;
    }
    t1 = $.penCanvas._graphics;
    C.JSArray_methods.set$length(t1._commands, 0);
    t1._identityRectangleRefresh = true;
    for (i = 0; t1 = $.get$pixels(), i < t1.length; ++i) {
      if (i > 1) {
        t2 = $.penCanvas._graphics;
        t3 = i - 1;
        t4 = J.get$x$x(t1[t3]);
        t3 = J.get$y$x(t1[t3]);
        t1 = new Z._GraphicsCommandMoveTo(null, null);
        t1._x = J.toDouble$0$n(t4);
        t1._y = J.toDouble$0$n(t3);
        t2._commands.push(t1);
        t2._identityRectangleRefresh = true;
      }
      t1 = $.penCanvas._graphics;
  ...
  main_closure1: {
    "^": "Closure:9;",
    call$1: function(e) {
      A.startStatic(C.JSNumber_methods.toInt$0(e.get$localX()), C.JSNumber_methods.toInt$0(e.get$localY()));
    }
  },
  startStatic_closure: {
    "^": "Closure:9;",
    call$1: function(e) {
      A.drawStatic(C.JSNumber_methods.toInt$0(e.get$localX()), C.JSNumber_methods.toInt$0(e.get$localY()));
    }
  },
