...
([["","file:///D:/_Carrier/Dropbox/mediakid@gmail.com/Dropbox/MyBox/_Development/Dart/_project/exploring-stagexl/web/graphics/TestingDrawing_v4.dart",,T,{
"^":"",
...
H.VM(new W.Ov(0,y.uv,y.Ph,W.VF(new T.em()),y.Sg),[H.Kp(y,0)]).Zz()
...
$.Gh=$.uV.Yf(0,C.Bt.fG).yI(new T.QA())},"call$0","eE",0,0,0],
WX:function(a,b){$.Li().push(new Z.hL(a,b))
$.rb=$.uV.Yf(0,C.Ck.fG).yI(new T.pW())
$.uV.Yf(0,C.lW.fG).yI(new T.jZ())},
...
z.q7.push(y)
z.zb=!0
for(u=1;z=$.Li(),y=z.length,x=$.aS,u<y;++u){y=x.z2
z=z[u]
x=J.Rd(z)
z=J.WQ(z)
...
y=$.aS
x=z.pO.gmH()
w=Z.mN(Z.TF(z.jw.i1),x,null,null)
y=y.z2
y.dd(w)
z.jw.Li()
z=$.aS.z2
...
QA:{
"^":"Tp:9;",
call$1:function(a){T.WX(C.CD.yu(a.gRd()),C.CD.yu(a.gCa()))}},
pW:{
"^":"Tp:9;",
call$1:function(a){T.xN(C.CD.yu(a.gRd()),C.CD.yu(a.gCa()))}},
jZ:{
"^":"Tp:9;",
call$1:function(a){T.ri()}}},1],["_foreign_helper","dart:_foreign_helper",,H,{
"^":"",
FK:{
...
return this.nw===b.nw&&this.Mb===b.Mb&&this.cR===b.cR},
...
static:{K1:function(a,b,c,d){return H.VM(new H.OV(a,b),[c,d])}}},
OV:{
"^":"i1;l6,T6"},
MH:{
"^":"An;lo,OI,T6",
...
$isiP:true,
static:{"^":"Oj,Vp,df,p2,ch,QC,Px,Yp,kc,Gi,k3,cR,E0,mj,kT,Nr,bm,FI,Kz,ek,yf,Fk",tc:function(a){var z,y
z=Math.abs(a)
y=a<0?"-":""
if(z>=1000)return""+a
...
$isa6:true,
static:{"^":"Wt,S4,dk,Lo,zj,b2,q9,Ie,Do,Cv,iy,IJ,D9,Vk,S8,rG",k5:function(a,b,c,d,e,f){return new P.a6(a*86400000000+b*3600000000+e*60000000+f*1000000+d*1000+c)}}},
P7:{
"^":"Tp:21;",
...
"%":";ArrayBufferView;LZ|Ob|GV|Dg|dy|BU|Pg"},
zU:{
"^":"Dg;",
t:function(a,b){var z=a.length
...
"^":"Tp:9;",
call$1:function(a){var z=J.x(a)
return typeof a==="object"&&a!==null&&!!z.$iscv}}}],["stagexl","package:stagexl/stagexl.dart",,Z,{
"^":"",
...
return b},
dq:function(a){return this.xi(a,null)},
l3:function(a,b){if(this.dq($.SG()).Is(0,a,b))return this
return},
...
w=y[x]
J.vQ(w,new Z.ea("removed",!0,2,null,null,!1,!1))
...
static:{"^":"fD"}},
Lz:{
"^":"IT;i1,dk,YF,wb,Op,Lb,N3,wJ,bi,TQ,XN,C3,oS,SG,xS,BL,lb,i8,VN,uc,cu,cO,US,tR,CX,QW,J0,Rb,fk,yD,Xr,zw,vX,iC,jg,k5,ER,PN,aU,b2,TY,oV,y6,Td,mh,Yk,HA,rG,lG,IV,SV,ta,nl,OL,xv,eH,mB",
gAT:function(){return this.oS},
No:function(a,b){var z=this.BL
...
Z.lo(this.Ad,$.lT())}for(v=0;v<z.length;++v)z[v].No(w,x)
...
init.metadata=[{func:"X0",void:true},{func:"G5",void:true,args:[null]},{func:"Vx",void:true,args:[null],opt:[P.mE]},,{func:"Gl",ret:J.kn,args:[null,null]},{func:"bX",ret:J.im,args:[null]},{func:"E0",ret:J.kn,args:[P.a,P.a]},{func:"DZ",ret:J.im,args:[P.a]},{func:"EC",ret:J.O,args:[W.D0]},{func:"Dv",args:[null]},{func:"u9",args:[Z.ya]},{func:"NT"},{func:"bh",args:[null,null]},{func:"np",args:[null,J.O]},{func:"zx",args:[J.O]},{func:"uu",void:true,args:[P.a],opt:[P.mE]},{func:"rt",ret:P.b8},{func:"yV",args:[null],opt:[null]},{func:"Uf",ret:J.kn},{func:"bb",args:[null,P.mE]},{func:"lv",args:[P.wv,null]},{func:"Pt",ret:J.O,args:[J.im]},{func:"bB",void:true,args:[W.OK]},{func:"Za",args:[J.O,null]},{func:"XF",args:[W.OK]},{func:"mc",args:[W.J6]},{func:"Np",args:[W.yT]},{func:"Se",args:[W.XF]},{func:"ub",args:[P.Sl]},{func:"c7",args:[J.P]},{func:"dG",args:[Z.ea]},];$=null
...
;(function (callback) {
  ...
  if (typeof dartMainRunner === "function") {
    dartMainRunner((function(a){H.Rq(T.eE(),a)}), []);
  } else {
    (function(a){H.Rq(T.eE(),a)})([]);
  }
})
function init(){I.p={}
...
function FD(mr,Rn,XZ,Rv,Ee,uU,AM,nn){this.mr=mr
this.Rn=Rn
this.XZ=XZ
this.Rv=Rv
this.Ee=Ee
...
if($desc instanceof Array)$desc=$desc[1]
Bp.prototype=$desc
function v(nw,Mb,cR,l1){this.nw=nw
this.Mb=Mb
this.cR=cR
...
if($desc instanceof Array)$desc=$desc[1]
od.prototype=$desc
function fE(ta){this.ta=ta}fE.builtin$cls="fE"
...
function Lz(i1,dk,YF,wb,Op,Lb,N3,wJ,bi,TQ,XN,C3,oS,SG,xS,BL,lb,i8,VN,uc,cu,cO,US,tR,CX,QW,J0,Rb,fk,yD,Xr,zw,vX,iC,jg,k5,ER,PN,aU,b2,TY,oV,y6,Td,mh,Yk,HA,rG,lG,IV,SV,ta,nl,OL,xv,eH,mB){this.i1=i1
this.dk=dk
this.YF=YF
this.wb=wb
this.Op=Op
...
if($desc instanceof Array)$desc=$desc[1]
HL.prototype=$desc
function PQ(ou,VR,of,iR){this.ou=ou
this.VR=VR
this.of=of
this.iR=iR}PQ.builtin$cls="PQ"
if(!"name" in PQ)PQ.name="PQ"
$desc=$collectedClasses.PQ
if($desc instanceof Array)$desc=$desc[1]
PQ.prototype=$desc
...
if($desc instanceof Array)$desc=$desc[1]
wJ.prototype=$desc
return[qE,Ps,rK,fY,Mr,lJ,ct,nB,i3,it,QP,IF,n6,Ny,Kh,TK,w9,Gc,nx,QQ,Ey,y4,d7,Um,Un,He,HA,vH,xO,Em,NW,rV,Wy,QF,hs,cm,BK,cv,Fs,hY,rg,D0,as,Aa,u5,Yu,iG,jP,Ax,xf,xn,Lv,QH,ST,X2,tb,pA,Mi,XF,In,wP,eP,A6,Og,M6,El,mC,SV,aB,fJ,Ih,D8,Vh,rC,ZY,cx,Ee,Qb,PG,F3,xI,OK,oU,eY,KV,BH,KY,G7,l9,ax,wL,bP,FH,SN,me,ni,rR,qj,nC,KR,kQ,fs,bX,lr,MC,iQ,LY,j2,Ea,lp,kd,I0,yN,Cp,ua,HN,Ul,KK,ii,Lx,h4,UK,GI,Tb,Ng,BT,yY,kJ,FB,xV,Pe,a9,yT,o4,RH,Kn,Z2,w6,BR,vw,aG,J6,Oi,UM,YC,hq,WS,r0,yp,c1,Mq,Nf,Nc,Mx,Zv,nA,yK,Dh,ZJ,mU,eZ,Bl,y5,JY,Pq,kx,nV,Zc,ui,D6,DQ,Sm,xL,es,jw,lv,pf,NV,W1,zo,wf,TU,ih,Nd,zp,Xu,lu,tk,US,oB,Ah,d4,MI,Ub,bM,pQ,Qy,ju,tB,N9,BA,d0,tp,rE,CC,Rx,uz,Yd,p8,AD,Gr,cs,GH,To,PY,NJ,qI,jf,rQ,fv,f6,d5,hy,r8,Ke,CG,UN,mD,Rk,Eo,YS,UD,ZD,vt,cu,Wv,vR,j8,Ja,zI,cB,LQ,j9,HP,fa,l4,Et,QS,Pi,qO,xt,tG,P0,xl,Dc,p0,Sl,Yo,V3,bf,Jo,iO,CA,Qm,WZ,ET,zU,xj,dE,V6,em,Lb,QA,pW,jZ,FK,Gv,kn,YE,Ue,iC,is,Q,P,im,VA,O,PK,JO,O2,aX,cC,RA,IY,JH,jl,vK,Iy,JM,Ua,ns,yo,Bj,NO,II,fP,X1,HU,oo,OW,Tf,iY,yH,FA,Av,ku,FD,Zr,W0,az,vV,Am,XO,dr,TL,KX,uZ,OQ,Tp,Bp,v,Eq,lb,tD,hJ,dC,wN,VX,a7,i1,OV,MH,U5,SO,SU,Ca,JI,WV,yZ,tK,OR,d2,Sr,b8,vs,da,xw,dm,rH,rq,RW,RT,FZ,ez,OM,qh,lz,Rl,Jb,M4,B5,PI,MO,Kd,UO,Bc,VT,Fj,tC,pS,Zz,Xi,MF,u8,yU,Uf,KA,Vo,qB,aN,fI,LV,DS,dp,B3,CR,Qk,QN,xP,Dq,dR,uR,fZ,K5,Xz,Cg,Hs,pK,eM,R8,k6,oi,fG,EQ,YB,a1,db,i5,N6,jg,YO,oz,b6,tj,zQ,u3,mW,ar,lD,ZQ,Sw,o0,CL,iP,a6,P7,DW,Ge,LK,AT,bJ,ub,ds,lj,UV,VS,t7,HG,kM,An,c8,a,mE,P1,Rn,wv,BV,id,VG,zL,ec,e7,dx,kE,hm,x5,I2,RO,eu,Ov,kG,Pb,W9,dW,IU,EX,IN,Vb,LZ,Dg,Ob,GV,Pg,dy,BU,J9,zW,D7,hT,DM,Gn,LE,jx,od,fE,IT,D3,pT,KO,ml,Q0,kR,cb,Wk,ap,lY,Kc,xC,HV,Zf,AE,Bg,CQ,Lz,Ez,UE,p5,I6,F7,E7,pr,nP,HL,PQ,up,IA,RK,ZL,ya,XV,b5,ea,pp,q4,e0,hw,Aj,y6,yW,hL,tn,wJ]}